...
clusterCountArray = clusterCountArray_O100;
FileName1 = 'Clustering_Information_O100.mat';
FileName2 = 'Clustering_Information_O500.mat';
...
clusterCountArray = clusterCountArray_O500;
%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%
