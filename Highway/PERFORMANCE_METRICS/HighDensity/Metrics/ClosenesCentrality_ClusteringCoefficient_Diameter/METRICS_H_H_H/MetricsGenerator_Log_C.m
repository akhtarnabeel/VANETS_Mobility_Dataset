...
clusterCountArray = clusterCountArray_L100_C;
FileName1 = 'Clustering_Information_L100_C.mat';
FileName2 = 'Clustering_Information_L500_C.mat';
...
clusterCountArray = clusterCountArray_L500_C;
%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%
