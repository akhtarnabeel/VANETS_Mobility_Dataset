...
clusterCountArray = clusterCountArray_U100;
FileName1 = 'Clustering_Information_U100.mat';
FileName2 = 'Clustering_Information_U500.mat';
...
clusterCountArray = clusterCountArray_U500;
%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%
